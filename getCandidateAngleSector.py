...
if __name__ == '__main__':
    ...
    # inversed_target_angle = False
    # check_with_360_relative_target_angle2 = relative_target_angle
    # minus_relative_target_angle360 = relative_target_angle
    # if relative_target_angle < 90 :
    check_with_360_relative_target_angle2 = 360 + relative_target_angle # было <90
    inversed_target_angle = True
